  ...
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm
          ...
          @confirm="delBatch"
      >
        <el-button type="danger" slot="reference" style="margin-left: 10px">批量删除 <i class="el-icon-remove-outline"></i></el-button>
      </el-popconfirm>
<!--      <el-upload :action="'http://' + serverIp + ':8080v/user/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">-->
<!--        <el-button type="primary" class="ml-5" style="margin-left: 10px">导入 <i class="el-icon-bottom"></i></el-button>-->
<!--      </el-upload>-->
<!--      <el-button type="primary" @click="exp" class="ml-5" style="margin-left: 10px">导出 <i class="el-icon-top"></i></el-button>-->
    </div>
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(`http://${serverIp}:8080/user/export`)
    },
